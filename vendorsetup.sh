...
echo 'Cloning Device Common Tree'
	git clone https://github.com/Infinity-X-Devices/device_xiaomi_sm8450-common -b 16 device/xiaomi/sm8450-common
...
echo 'Cloning Hardware Dolby Tree'
	git clone https://github.com/Infinity-X-Devices/hardware_dolby -b 16 hardware/dolby
...
echo 'Cloning Vendor Tree'
	git clone https://github.com/Infinity-X-Devices/vendor_xiaomi_marble -b 16 vendor/xiaomi/marble

echo 'Cloning Vendor Common Tree'
	git clone https://github.com/Infinity-X-Devices/vendor_xiaomi_sm8450-common -b 16 vendor/xiaomi/sm8450-common
